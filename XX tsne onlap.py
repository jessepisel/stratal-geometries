...
# %% [markdown]
# Set the colors for the classes and some custom colormaps
...
# %% [markdown]
# Import the training data for 20 adjacent wells, and split into test train subsets
...
# %% [markdown]
# Instantiate the classifier and do another grid search to find optimal parameters

# %%
from sklearn.neighbors import KNeighborsClassifier
neigh = KNeighborsClassifier(n_neighbors=5, algorithm='ball_tree', leaf_size=10, metric='manhattan', weights='distance')

# %% [markdown]
# Train the classifier with the optimal parameters
...
thickened = ['thickness neighbor 1', 'thickness neighbor 2',
       ...
       'thickness neighbor 19', 'thickness neighbor 20','thickness neighbor 21','thickness neighbor 22', 
             'thickness neighbor 23','thickness neighbor 24','thickness neighbor 25', 'class']
logged = ['thickness natural log', 'thickness natural log neighbor 1',
       ...
       'thickness natural log neighbor 20','thickness natural log neighbor 21','thickness natural log neighbor 22',
          'thickness natural log neighbor 23','thickness natural log neighbor 24','thickness natural log neighbor 25','class']
powered = ['thickness power',
       ...
       'thickness power neighbor 19', 'thickness power neighbor 20','thickness power neighbor 21','thickness power neighbor 22',
           'thickness power neighbor 23','thickness power neighbor 24','thickness power neighbor 25','class']
...
print(f'Done with original thickness. Accuracy is {og_t_removed:.2f}')

# %% [markdown]
# Train the classifier again on the full training dataset
...
# %% [markdown]
# Read in the subsurface dataset
...
# %% [markdown]
# Now we do feature engineering for the subsurface dataset, and make predictions using the classifier
